...
if resume:
  model = pickle.load(open('save200-100-r2.p', 'rb'))
else:
  model = {}
...
def policy_backward(eph1, eph2, epx, epdlogp):
  ...
  dh1 = np.dot(model['W2'].T, dh2.T)
  #print(w23)
  #w23[eph2 <= 0] = 0 # backpro prelu
  dh1[eph1.T <= 0] = 0 # backpro prelu
  dW1 = np.dot(dh1, epx)
...
while True:
  ...
  if done: # an episode finished
    ...
    if episode_number % 100 == 0: pickle.dump(model, open('save200-100-r2.p', 'wb'))
    reward_sum = 0
