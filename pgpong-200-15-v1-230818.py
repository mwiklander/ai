...
# r1 - ran 18000 until unintentonally intrupted, continue in r2
# r2 - continue
...
H2 = 15 # number of hidden second layer neurons, k below
...
if resume:
  model = pickle.load(open('save200-15-r2.p', 'rb'))
else:
  model = {}
...
while True:
  ...
  observation, reward, done, fff, info = env.step(action)
  reward_sum += reward
  ...
  if done: # an episode finished
    ...
    if episode_number % 100 == 0: pickle.dump(model, open('save200-15-r2-230818.p', 'wb'))
    reward_sum = 0
